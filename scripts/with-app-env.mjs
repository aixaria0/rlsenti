#!/usr/bin/env node
/**
 * Run a command with the optional workspace environment overlay merged into
 * the process environment. Only VITE_* values are accepted from the file.
 */
...
export const APP_ENV_REL_PATH = ".rlsenti/app-env.json";
